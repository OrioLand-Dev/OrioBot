    ...
    try {
      ...
      message.channel.send({ embeds: [
        new Discord.MessageEmbed()
          ...
          .addField( `<:people:893553167902572605> ${client.language.SERVERINFO[11]}`, "```" + `${guild.memberCount}` + "```", true )
          .addField( `😀 ${client.language.SERVERINFO[12]} [${emojis.size}]`, `😀 ${client.language.SERVERINFO[13]}: ${emojis.filter((emoji) => !emoji.animated).size }\n<a:arrow:893553167860629505> ${client.language.SERVERINFO[14] }: ${emojis.filter((emoji) => emoji.animated).size}`, true )
          .addField( `<:ticketblurple:893490671615361024> ${client.language.SERVERINFO[15]}`, "```" + `${role.length}` + "```", true )
          .addField( `<:textchannelblurple:893490117451333632> ${client.language.SERVERINFO[16]} [${guild.channels.cache.size}]`, `<:category:864116468291338290> ${client.language.SERVERINFO[17] }: ${guild.channels.cache.filter((x) => x.type === "GUILD_CATEGORY").size}\n<:textchannelblurple:863983092893220885> ${client.language.SERVERINFO[18] }: ${guild.channels.cache.filter((x) => x.type === "GUILD_TEXT").size }\n<:voicechannelblurple:864103406309867531> ${client.language.SERVERINFO[19] }: ${guild.channels.cache.filter((x) => x.type === "GUILD_VOICE").size}`, true )
          .addField( `📆 ${client.language.SERVERINFO[20]}`, "```" + `${create}` + "```", true )
          .addField( `<:booster:910575702875734086> ${client.language.SERVERINFO[21]}`, "```" + `${boostcount}` + "```", true )
          .addField( `<:money:893553167596421131> ${client.language.SERVERINFO[22]}`, `${boost ? "```" + `${client.language.SERVERINFO[23]} ${boost}` + "```" : "```" + `No` + "```" }`, true, true )
